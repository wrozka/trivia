module UglyTrivia
  ...
  private
    ...
    def current_category
      return 'Pop' if [0, 4, 8].include?(@places[@current_player])
      return 'Science' if [1, 5, 9].include?(@places[@current_player])
      return 'Sports' if [2, 6, 10].include?(@places[@current_player])
      return 'Rock'
    end
